...
template = '''
    ...
    <html lang="en-US">
        ...
        <body>
            <h1>Adding a salary</h1>
            <a class="h3 link-primary" href="/">Go back</a>
            <div class="ps-4 pe-4">
                <form method="GET">
                    <label class="form-label" for="name_stock">Total sum</label>
                    <input class="form-control" type="text" name="name_stock" required>
                    <br>
                    <label class="form-label" for="start_stock">The first part of the salary</label>
                    <input class="form-control" type="text" name="start_stock" required>
                    <br>
                    <label class="form-label" for="finish_stock">The second part of the salary</label>
                    <input class="form-control" type="text" name="finish_stock" required>
                    <br>
                    <label class="form-label" for="percent_stock">Work success rate (in %)</label>
