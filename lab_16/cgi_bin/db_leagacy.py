...
# INSERT INTO product(name_product, catagory, type, id_brend, id_stock) VALUES
    con.execute("""
            INSERT INTO product(name_product, catagory, type, id_brend, id_stock) VALUES
           ('Rustam', 'Boss', '18','Hotel228', '12223'),
           ('Daniil', 'Deputy boss', '20','YEEE', '122333'),
           ('Sergay', 'Hacker', '27','NoTell', '123566'),
    """)
...
def add_stock(name_stock, start_stock, finish_stock, percent_stock):
    ...
    execute_insert_commit(sql, (name_stock, start_stock,
                          finish_stock, percent_stock))
...
def add_product(name_product, catagory, type, id_brend, id_stock):
    ...
    execute_insert_commit(
        sql, (name_product, catagory, type, id_brend, id_stock))
